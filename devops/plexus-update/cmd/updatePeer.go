...
// updatePeerCmd represents the updatePeer command
var updatePeerCmd = &cobra.Command{
	Use:   "updatePeer",
...
func init() {
	networkCmd.AddCommand(updatePeerCmd)

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// updatePeerCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// updatePeerCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
