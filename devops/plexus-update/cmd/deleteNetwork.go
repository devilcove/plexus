...
var deleteNetworkCmd = &cobra.Command{
	Use:   "deleteNetwork netName peer",
...
func init() {
	...
	// deleteNetworkCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// deleteNetworkCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
